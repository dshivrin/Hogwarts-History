...
Include text_anchor on every entry.
Always wrap quote_excerpt_short in YAML string quotes.
...
3. If a previous chapter has already been processed, begin scanning from that previous chapter's end page, not from page 1.
